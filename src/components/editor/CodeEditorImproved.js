...
export default function CodeEditorImproved({ 
  initialCode = '', 
  language = 'javascript',
  height = '400px',
  onCodeChange,
  ...
  return (
    <div className={`w-full rounded-lg border ${theme === 'dark' ? 'border-gray-600' : 'border-gray-300'} overflow-hidden shadow-lg`}>
      {/* Barre d'outils */}
      ...
      <div className={`flex ${splitView && previewVisible ? 'flex-col lg:flex-row' : 'flex-col'}`}>
            ...
            <div className="absolute inset-0 flex">
              ...
              <div className="relative flex-1 overflow-hidden">
                ...
                <textarea
                  ...
                  className={`absolute inset-0 p-3 font-mono text-sm resize-none focus:outline-none leading-6 z-20 ${
                    theme === 'dark' 
                  ...
                  autoCorrect="off"
                  data-gramm="false"
                  placeholder={readOnly ? "Code en lecture seule" : "Tapez votre code ici..."}
                />
                ...
                {false && (
                  <pre 
                    ref={preElementRef}
                    className={`absolute inset-0 p-3 font-mono text-sm leading-6 overflow-auto m-0 ${
        ...
        {previewVisible && (
          ...
          >
            <div className={`p-4 h-full ${theme === 'dark' ? 'bg-gray-800' : 'bg-gray-50'}`}>
              <CodePreviewSandbox 
                code={previewCode} 
                language={language} 
      ...
      {/* Styles CSS personnalisés pour améliorer la lisibilité */}
      <style dangerouslySetInnerHTML={{
        __html: `
          .token-dark .token.comment,
          .token-dark .token.prolog,
          .token-dark .token.doctype,
          .token-dark .token.cdata {
            color: #6272a4;
          }
          
          .token-dark .token.punctuation {
            color: #f8f8f2;
          }
          
          .token-dark .token.property,
          .token-dark .token.tag,
          .token-dark .token.constant,
          .token-dark .token.symbol,
          .token-dark .token.deleted {
            color: #ff79c6;
          }
          
          .token-dark .token.boolean,
          .token-dark .token.number {
            color: #bd93f9;
          }
          
          .token-dark .token.selector,
          .token-dark .token.attr-name,
          .token-dark .token.string,
          .token-dark .token.char,
          .token-dark .token.builtin,
          .token-dark .token.inserted {
            color: #50fa7b;
          }
          
          .token-dark .token.operator,
          .token-dark .token.entity,
          .token-dark .token.url,
          .token-dark .language-css .token.string,
          .token-dark .style .token.string,
          .token-dark .token.variable {
            color: #f8f8f2;
          }
          
          .token-dark .token.atrule,
          .token-dark .token.attr-value,
          .token-dark .token.function,
          .token-dark .token.class-name {
            color: #f1fa8c;
          }
          
          .token-dark .token.keyword {
            color: #8be9fd;
          }
          
          .token-dark .token.regex,
          .token-dark .token.important {
            color: #ffb86c;
          }
          
          .token-light .token.comment,
          .token-light .token.prolog,
          .token-light .token.doctype,
          .token-light .token.cdata {
            color: #708090;
          }
          
          .token-light .token.punctuation {
            color: #24292e;
          }
          
          .token-light .token.property,
          .token-light .token.tag,
          .token-light .token.constant,
          .token-light .token.symbol,
          .token-light .token.deleted {
            color: #d73a49;
          }
          
          .token-light .token.boolean,
          .token-light .token.number {
            color: #005cc5;
          }
          
          .token-light .token.selector,
          .token-light .token.attr-name,
          .token-light .token.string,
          .token-light .token.char,
          .token-light .token.builtin,
          .token-light .token.inserted {
            color: #032f62;
          }
          
          .token-light .token.operator,
          .token-light .token.entity,
          .token-light .token.url,
          .token-light .language-css .token.string,
          .token-light .style .token.string,
          .token-light .token.variable {
            color: #24292e;
          }
          
          .token-light .token.atrule,
          .token-light .token.attr-value,
          .token-light .token.function,
          .token-light .token.class-name {
            color: #6f42c1;
          }
          
          .token-light .token.keyword {
            color: #d73a49;
          }
          
          .token-light .token.regex,
          .token-light .token.important {
            color: #e36209;
          }
        `
      }} />
